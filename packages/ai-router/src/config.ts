...
// Model routing: summarize_article uses GPT-5, web_search uses Brave Search API (handled before routing), librarian uses gpt-5-mini, others use gpt-5
export const routingRules: Record<AiIntent, { model: string; providerId: string }> = {
  ...
  librarian: { model: "gpt-5-mini", providerId: "openai-gpt5-mini" },  // GPT-5 Mini for Librarian
};
