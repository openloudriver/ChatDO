...
// Model routing: summarize_article uses GPT-5, web_search uses Brave Search API (handled before routing), librarian uses gpt-5-nano, others use gpt-5
export const routingRules: Record<AiIntent, { model: string; providerId: string }> = {
  ...
  librarian: { model: "gpt-5-nano", providerId: "openai-gpt5-nano" },  // GPT-5 Nano for Librarian
};
